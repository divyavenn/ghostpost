  ...
  return (
    <div className="relative w-full max-w-2xl aspect-[3/4] overflow-hidden rounded-2xl bg-gradient-to-br from-blue-950 via-blue-900 to-slate-900 shadow-2xl">
      ...
      <svg className="absolute inset-0 w-full h-full opacity-20" viewBox="0 0 400 600" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="darkTexture1" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
          ...
          <pattern id="colorTexture1_1" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
          ...
          <pattern id="colorTexture2_1" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
          ...
          <pattern id="colorTexture3_1" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
      ...
      {/* Content */}
      <div className="relative z-10 h-full flex flex-col items-start justify-center px-16 py-20">
        <motion.div
        ...
        >
          <div className="space-y-6">
            ...
            >
              <h1 className="text-blue-50 font-serif tracking-tight italic leading-tight">
                <span className="text-4xl md:text-5xl block">Ghostposter</span>
                <span className="text-3xl md:text-4xl block mt-2 opacity-90">is the future</span>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 via-blue-400 to-blue-300 text-5xl md:text-6xl block mt-1">
                  of writing.
                </span>
              </h1>
            </motion.div>
            ...
            <motion.div
              className="w-20 h-px bg-gradient-to-r from-blue-400/80 to-transparent"
              initial={{ scaleX: 0 }}
              animate={{ scaleX: 1 }}
